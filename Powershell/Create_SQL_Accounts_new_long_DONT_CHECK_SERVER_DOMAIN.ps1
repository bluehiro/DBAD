...
#     .\Create_SQL_Accounts_new_long.ps1 -hostname foo
#
# Example #2 - Create additional account types
#     .\Create_SQL_Accounts_new_long.ps1 -hostname bar -types sql,agent,ssrs,ssis
#
# ITG ECSV
# May 14, 2013
...
## vizen - 06/30/14 Don't exit if server name fails the account check.  
## This is necessary for an ACC server that doesn't live in the OHSUM01 domain.
#if ($compObject) {
