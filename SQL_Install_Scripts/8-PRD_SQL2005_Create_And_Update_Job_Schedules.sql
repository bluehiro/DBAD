...
--Select @DayOfWeek_SDFD as DayOfWeek, @HourInterval_SDFD as HourInterval, @MinInterval_SDFD as MinInterval, @StartTime_SDFD as StartTime_SDFD, @HourInterval_SDFD as HourInterval_SDFD, @MinInterval_SDFD as MinInterval_SDFD, @Schedule_StartTime_SDFD as Schedule_StartTime
